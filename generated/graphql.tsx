...
export type LatestCartsQueryVariables = Exact<{ [key: string]: never; }>;


export type LatestCartsQuery = (
  { __typename?: 'Query' }
  & { checkouts?: Maybe<(
    { __typename?: 'CheckoutCountableConnection' }
    & { edges: Array<(
...
export const LatestCartsDocument = gql`
    query LatestCarts {
...
/**
 * __useLatestCartsQuery__
 *
 * To run a query within a React component, call `useLatestCartsQuery` and pass it any options that fit your needs.
 * When your component renders, `useLatestCartsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLatestCartsQuery({
 *   variables: {
 *   },
 * });
 */
export function useLatestCartsQuery(baseOptions?: Apollo.QueryHookOptions<LatestCartsQuery, LatestCartsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LatestCartsQuery, LatestCartsQueryVariables>(LatestCartsDocument, options);
      }
export function useLatestCartsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LatestCartsQuery, LatestCartsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LatestCartsQuery, LatestCartsQueryVariables>(LatestCartsDocument, options);
        }
export type LatestCartsQueryHookResult = ReturnType<typeof useLatestCartsQuery>;
export type LatestCartsLazyQueryHookResult = ReturnType<typeof useLatestCartsLazyQuery>;
export type LatestCartsQueryResult = Apollo.QueryResult<LatestCartsQuery, LatestCartsQueryVariables>;